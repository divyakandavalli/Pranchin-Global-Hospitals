        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 md:gap-10 mt-10 xl:max-w-[95%] 3xl:max-w-[85%] mx-auto">
          ...
          {services.map((item, index) => (
            ...
            >
              ...
              {/* Arrow Corner */}
              <div className="bg-[#fff] w-[80px] sm:w-[94px] min-h-[70px] sm:min-h-[84px] rounded-bl-[48px] flex justify-end items-start self-end relative">
                ...
                {/* corners */}
                <div className="absolute top-0 -left-[32px] w-[32px] h-[32px] rounded-tr-[16px] shadow-[8px_-4px_0_0_#fff]" />
                <div className="absolute -bottom-[32px] right-0 w-[32px] h-[32px] rounded-tr-[16px] shadow-[8px_-4px_0_0_#fff]" />
              </div>
              ...
              <div className="bg-[#fff] w-[85%] sm:w-[300px] md:w-[350px] flex justify-end gap-4 border-t-[12px] border-r-[12px] border-[#fff] rounded-tr-[16px] relative">
                ...
                {/* corners */}
                <div className="absolute -top-[44px] left-0 w-[32px] h-[32px] rounded-bl-[16px] shadow-[-8px_4px_0_0_#fff]" />
                <div className="absolute -right-[44px] bottom-0 w-[32px] h-[32px] rounded-bl-[16px] shadow-[-8px_4px_0_0_#fff]" />
              </div>
