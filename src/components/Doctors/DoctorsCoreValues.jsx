        ...
        <div className="grid xl:grid-cols-3  grid-cols-1 lg:gap-12 gap-6 mx-auto mt-12 lg:mx-8">
          {services.map((item, index) => (
            <div key={index} className="p-8 bg-[#c8dded] flex items-start justify-center flex-col rounded-3xl relative">
              ...
              <div className="w-20 absolute flex  rounded-tl-3xl pt-[10px] font-manrope bg-white bottom-0 right-0   justify-end items-end">
                <img src={item.img} className="w-16 h-16" alt="" />
                <div className="absolute -left-8 bottom-0 w-8 flex rounded-[0px_0px_16px_0] shadow-[8px_8px_0px_0px_#FFF]">
                  <div className="w-8">
                    <div className="w-8">
                ...
                <div className="absolute -top-[33px] right-0 w-[33px] flex rounded-[0px_0px_16px_0] shadow-[8px_8px_0px_0px_#FFF]">
                  <div className="w-8">
                    <div className="w-8">
                      <div className="h-8"></div>
                    </div>
...
export default DoctorsCoreValues;
