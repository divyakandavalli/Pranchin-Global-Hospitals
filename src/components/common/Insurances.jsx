...
const Insurances = () => {
  ...
  return (
    <div className="w-full flex flex-col md:gap-12 gap-6 my-20">
      <h2 className=" md:text-5xl text-center  text-3xl xl:leading-[74px] md:leading-[54px] leading-10 font-semibold ">
        Insurance,{" "}
