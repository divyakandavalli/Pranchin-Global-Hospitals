...
const HealthPackagesMobile = () => {
  ...
  return (
    <div className="w-[95%] mx-auto md:hidden block space-y-3 py-10">
      <div className=" overflow-hidden">
        ...
        >
          ...
          <span className="bg-[#f5d1b9] text-[#f37721] rounded-full w-9 h-9 flex items-center justify-center text-[16px] md:text-[18px]">
            {activeId === 1 ? (
        ...
        >
          <div className=" bg-[#e5f4ff] rounded-2xl my-4 py-4 xl:px-10 px-4">
            ...
            <div className="mb-5">
              <h3 className="text-[16px] md:text-[18px] font-bold text-[#f37721]">
                Price (₹): <span>5900/-</span>{" "}
                <span className="text-sm italic line-through text-[#5187af]">
                  8050/-
                </span>
              </h3>
            </div>
            <div className="lg:ps-5 ps-2">
              <div className="">
                ...
                <ul className="p-2.5">
                  <li className="flex flex-row gap-3 items-center text-sm font-medium">
                ...
                <ul className="p-2.5">
                  {[
                    ...
                    <li
                      ...
                      className="flex flex-row gap-1 py-0.5 items-center text-sm font-medium"
                    >
              ...
              <div className="">
                ...
                <ul className="p-2.5">
                  <li className="flex flex-row gap-1 py-0.5 items-center text-sm font-medium">
                    <VerifiedIcon className="text-[#5187af]"  fontSize="small" /> Complete Blood
      ...
      <div className=" overflow-hidden">
        ...
        >
          <span className="font-bold text-sm">SMART THYROID HEALTH CHECKUP</span>{" "}
          <span className="bg-[#f5d1b9] text-[#f37721] rounded-full w-9 h-9 flex items-center justify-center text-[16px] md:text-[18px]">
            {activeId === 2 ? (
              <SouthIcon fontSize="small" />
            ) : (
      ...
      <div className=" overflow-hidden">
        ...
        >
          <span className="font-bold text-sm">KIDNEY CHECK-UP</span>{" "}
          <span className="bg-[#f5d1b9] text-[#f37721] rounded-full w-9 h-9 flex items-center justify-center text-[16px] md:text-[18px]">
            {activeId === 3 ? (
              <SouthIcon fontSize="small" />
            ) : (
      ...
      <div className=" overflow-hidden">
        ...
        >
          <span className="font-bold text-sm">COMPLETE BONE HEALTH CHECK-UP</span>{" "}
          <span className="bg-[#f5d1b9] text-[#f37721] rounded-full w-9 h-9 flex items-center justify-center text-[16px] md:text-[18px]">
            {activeId === 4 ? (
              <SouthIcon fontSize="small" />
            ) : (
        ...
        >
          <div className=" bg-[#e5f4ff] rounded-2xl my-4 py-4 xl:px-10 px-4">
            ...
            <div className="lg:ps-5 ps-2">
              <div className="">
                <h4 className="text-[16px] md:text-[18px] font-bold pb-3">
                  <EmergencyIcon className="text-[#f37721]"  fontSize="small" />{" "}
      ...
      <div className=" overflow-hidden">
        ...
        >
          <span className="font-bold text-sm">ESSENTIAL HEART CHECK-UP</span>{" "}
          <span className="bg-[#f5d1b9] text-[#f37721] rounded-full w-9 h-9 flex items-center justify-center text-[16px] md:text-[18px]">
            {activeId === 5 ? (
              <SouthIcon fontSize="small" />
            ) : (
      ...
      <div className=" overflow-hidden">
        ...
        >
          <span className="font-bold text-sm">ESSENTIAL GASTRO CHECK-UP</span>{" "}
          <span className="bg-[#f5d1b9] text-[#f37721] rounded-full w-9 h-9 flex items-center justify-center text-[16px] md:text-[18px]">
            {activeId === 6 ? (
              <SouthIcon fontSize="small" />
            ) : (
      ...
      <div className=" overflow-hidden">
        ...
        >
          <span className="font-bold text-sm">COMPREHENSIVE GASTRO CHECK-UP</span>{" "}
          <span className="bg-[#f5d1b9] text-[#f37721] rounded-full w-9 h-9 flex items-center justify-center text-[16px] md:text-[18px]">
            {activeId === 7 ? (
              <SouthIcon fontSize="small" />
            ) : (
      ...
      <div className=" overflow-hidden">
        ...
        >
          <span className="font-bold text-sm">LUNG CARE CHECK-UP</span>{" "}
          <span className="bg-[#f5d1b9] text-[#f37721] rounded-full w-9 h-9 flex items-center justify-center text-[16px] md:text-[18px]">
            {activeId === 8 ? (
              <SouthIcon fontSize="small" />
            ) : (
      ...
      <div className=" overflow-hidden">
        ...
        >
          <span className="font-bold text-sm">MASTER HEALTH CHECK-UP</span>{" "}
          <span className="bg-[#f5d1b9] text-[#f37721] rounded-full w-9 h-9 flex items-center justify-center text-[16px] md:text-[18px]">
            {activeId === 9 ? (
              <SouthIcon fontSize="small" />
            ) : (
          ...
          <div className=" bg-[#e5f4ff] rounded-2xl my-4 py-4 xl:px-10 px-4">
            ...
            <div className="lg:ps-5 ps-2">
              <div className="">
                ...
                <ul className="p-2.5">
                  <li className="flex flex-row gap-3 items-center py-1 text-sm font-medium">
                    <VerifiedIcon className="text-[#5187af]"  fontSize="small" /> Complete Blood
                    Count (CBC)
                  </li>
                  <li className="flex flex-row gap-3 items-center py-1 text-sm font-medium">
      ...
      <div className=" overflow-hidden">
        ...
        >
          <span className="font-bold text-sm">PREGNANCY PROFILE</span>{" "}
          <span className="bg-[#f5d1b9] text-[#f37721] rounded-full w-9 h-9 flex items-center justify-center text-[16px] md:text-[18px]">
            {activeId === 10 ? (
              <SouthIcon fontSize="small" />
            ) : (
      ...
      <div className=" overflow-hidden">
        ...
        >
          <span className="font-bold text-sm">DIABETIC CHECK-UP</span>{" "}
          <span className="bg-[#f5d1b9] text-[#f37721] rounded-full w-9 h-9 flex items-center justify-center text-[16px] md:text-[18px]">
            {activeId === 11 ? (
              <SouthIcon fontSize="small" />
            ) : (
      ...
      <div className=" overflow-hidden">
        ...
        >
          <span className="font-bold text-sm">WELL WOMEN CHECK-UP</span>{" "}
          <span className="bg-[#f5d1b9] text-[#f37721] rounded-full w-9 h-9 flex items-center justify-center text-[16px] md:text-[18px]">
            {activeId === 12 ? (
              <SouthIcon fontSize="small" />
            ) : (
      ...
      <div className=" overflow-hidden">
        ...
        >
          <span className="font-bold text-sm">CANCER SCREENIG</span>{" "}
          <span className="bg-[#f5d1b9] text-[#f37721] rounded-full w-9 h-9 flex items-center justify-center text-[16px] md:text-[18px]">
            {activeId === 13 ? (
              <SouthIcon fontSize="small" />
            ) : (
      ...
      <div className=" overflow-hidden">
        ...
        >
          <span className="font-bold text-sm">EXECUTIVE HEALTH CHECK UP</span>{" "}
          <span className="bg-[#f5d1b9] text-[#f37721] rounded-full w-9 h-9 flex items-center justify-center text-[16px] md:text-[18px]">
            {activeId === 14 ? (
              <SouthIcon fontSize="small" />
            ) : (
