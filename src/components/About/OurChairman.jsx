...
import homeBanner from "../../assets/images/chairman_2.jpeg";
export default function OurChairman() {
  return (
    <section  id="our-chairman" className=" 3xl:max-w-[80%] w-[95%] bg-[#c8dded] mx-auto md:px-10 px-5 my-5 rounded-3xl py-10 ">
      ...
      <div className=" flex lg:flex-row flex-col  xl:gap-10 lg:gap-5 gap-4 items-center mt-7 md:mt-14">
        {/* LEFT IMAGE */}
        ...
        <div className="flex flex-col gap-1 xl:items-start items-center ">
          <p className=" mt-4 font-manrope text-[#66686c] text-sm text-justify">
          ...
          <p className=" mt-2 font-manrope text-[#66686c] text-sm text-justify">
